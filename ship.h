...
//	Given the ship id, the array of triples and the permission to move, it
...
//	Updates the request/reply values of the ship with specified id. 
void update_rr(int id, int repl, int req);

//	Returns reply_access value associated to the given ship_id
bool get_repl(int ship_id);

//	Returns request_access value associated to the given ship_id
